...
export const brew_antivenin = <div className="default">A vile and brackish concoction. Nevertheless, one ounce is all that is required to cure ongoing poisons and ailments. The reaction yields 4 ounces of the substance.</div>

export const brew_curative_potion = <div className="default">A crimson philter of lion or bear's blood is precipitated in alchemical solution. The reaction yields 4 ounces of liquid, which are stored in a stoppered flask. As an action, you may drink up to 4 ounces from the flask, healing 1d4 damage each.</div>

export const brew_eloquence_philter = <div className="default">A xanthous solution of egg yolk and four-leaf clovers is condensed from an alchemical mixture. The reaction yields 1 ounce of liquid, which is stored in a vial. As an action, you may drink the contents of the vial, gaining 1 point of charisma until the next long rest.</div>

export const brew_amphibic_philter = <div className="default">Produces a viscous extract, condensed from an alchemical mixture of frog feet and fish scales. The reaction yields 1 ounce of liquid, which is stored in a vial. As an action, you may drink the contents of the vial, gaining the ability to breathe underwater for 30 minutes.</div>

export const brew_anaesthetic_potion = <div className="default">Produces a transparent liquid, distilled from an alchemical solution of crushed glass and mermaid tears. The reaction yields 1 ounce of liquid, which is stored in a vial. In drinking the potion, you gain 2d6 temporary HP and 1d4 temporary willpower, and your nerves are greatly dulled to the sensation of pain.</div>

export const brew_hermetic_philter = <div className="default">A pale solution of ostrich feathers and gazelle blood is condensed from an alchemical mixture. The reaction yields 1 ounce of liquid, which is stored in a vial. As an action, you may drink the contents of the vial, gaining 1 point of speed until the next long rest.</div>

export const brew_vigor_philter = <div className="default">Produces an effervescent yellow potion which swirls without cessation. The reaction produces 1 ounce of product, which is stored in a vial. As an action, you may drink the contents of the vial, gaining 2 points of dexterity until the next long rest.</div>

export const brew_persistence_philter = <div className="default">A cerulean solution of crushed pearl and gold dust is extracted from an alchemical solution. The reaction yields 1 ounce of liquid, which is stored in a vial. As an action, you may drink the contents of the vial, gaining 1 point of intelligence until the next long rest.</div>

export const brew_hallucinogenic = <div className="default">A cerulean solution of crushed pearl and gold dust is extracted from an alchemical solution. The reaction yields 1 ounce of liquid, which is stored in a vial. As an action, you may drink the contents of the vial, gaining 1 point of intelligence until the next long rest.</div>

export const brew_acumen_philter = <div className="default">Produces a cerulean solution of crushed pearl and gold dust, which forms at the top of an alchemical mixture. The reaction yields 1 ounce of product, which is stored in a vial. As an action, you may drink the contents of the vial, gaining 2 points of intelligence until the next long rest.</div>

export const brew_potency_philter = <div className="default">A cerulean solution of crushed pearl and gold dust is extracted from an alchemical solution. The reaction yields 1 ounce of liquid, which is stored in a vial. As an action, you may drink the contents of the vial, gaining 1 point of intelligence until the next long rest.</div>

export const brew_invisibility_potion = <div className="default">A glowing, translucent potion remains after aught else is boiled away. The reaction yields 1 ounce of liquid, which is stored in a vial. As an action, you may drink the contents of the vial, so becoming invisible for 10 minutes.</div>

export const brew_elixir_of_invulnerability = <div className="default">A dark crimson concoction derived from crushed bricks, tar, and grass plucked from between cobblestones. The reaction yields 1 ounce of liquid, which is stored in a vial. As an action, you may drink the contents of the vial, gaining immunity to all forms of damage for 1 minute.</div>

export const brew_elixir_of_immortality = <div className="default">A shimmering gold solution containing the essence of life is distilled from an alchemical solution. The reaction yields 1 ounce of liquid, stored in a vial. As an action, you may drink the contents of the vial, so extending your life by 500 years.</div>

export const brew_aphrodisiac = <div className="default">Produces a rosy pink concoction, brewed from crushed rose petals and thorns of the same. The reaction yields 1 ounce of liquid, which is stored in a vial. With an action, you can coat a weapon or up to ten arrows with the solution. Any target damaged by these weapons must pass a DT 11 willpower saving throw or fall in love with the next being it sees, of the appropriate gender and species.</div>

export const brew_necrotoxin = <div className="default">A pungent decoction derived from spider fangs and toadstool powder emerges after being separated from waste product. The reaction yields 1 ounce of liquid, which is stored in a vial. With an action, you can coat a weapon or up to ten arrows with the solution. Any target damaged by these weapons must pass a DT 11 willpower saving throw accumulate one level of necrotic poisoning, dealing 1d4 damage at the start of its turn.</div>

export const brew_brimstone = <div className="default">A frothing, ochre concentrate of sulfur is distilled in alchemical solution. The reaction yields 4 ounces of liquid, which are stored in a stoppered flask. The contents of the flask can be thrown at an enemy, dealing 2d6 acid damage and reducing their armor by 1.</div>

export const brew_narcoleptic_toxin = <div className="default">A warm and bubbly solution of butter and silver dust is dissolved in alchemical solution. The reaction yields 1 ounce of liquid, which is stored in a vial. With an action, you can coat a weapon or up to ten arrows with the solution. Any target damaged by these weapons must pass a DT 12 willpower saving throw or fall into a slumber (becoming <Tooltip tip={"Incapacitated"}>The target cannot take actions or reactions, and automatically fails ability checks and saving throws. DC is reduced to zero.</Tooltip>) for 1d10 turns, or until damaged.</div>

export const brew_lethargic_toxin = <div className="default">A viscous solution with a metallic luster remains after an alchemical mixture of algae and ogre bile has evaporated. The reaction yields 1 ounce of liquid, which is stored in a vial. With an action, you can coat a weapon or up to ten arrows with the solution. Any target damaged by these weapons must pass a DT 13 willpower saving throw or suffer -1 to STR, SPD, and DEX scores.</div>

export const brew_debilitative = <div className="default">A tepid solution of nightshade oil and ocular jelly is dissolved in alchemical solution. The reaction yields 1 ounce of liquid, which is stored in a vial. With an action, you can coat a weapon or up to ten arrows with the solution. Any target damaged by these weapons must pass a DT 14 willpower saving throw or suffer -1 to INT, CHA, and WILL scores.</div>

export const brew_enervative = <div className="default">A frothing solution of nettles and thistle is distilled from an alchemical solution. The reaction yields 1 ounce of liquid, which is stored in a vial. With an action, you can coat a weapon or up to ten arrows with the solution. Any target damaged by these weapons loses 1d4 willpower for each hit.</div>

export const brew_neurotoxin = <div className="default">A potent concentrate of serpent venom is precipitated in alchemical solution. The reaction yields 1 ounce of liquid, which is stored in a vial. With an action, you can coat a weapon or up to ten arrows with the solution. Any target damaged by these weapons must pass a DT 12 willpower saving throw or become paralysed.</div>

export const brew_aqua_regia = <div className="default">The alchemical ritual renders an extremely volatile acid that even dissolves inert metals such as gold and platinum. The reaction yields four ounces of liquid, which are stored in a stoppered flask. When thrown at a target after the incantation has been uttered, it deals 4d6 acid damage and reduces armor by 3.</div>

export const brew_liquid_light = <div className="default">A viscous, glowing solution of yellow-white light appears overnight after the proper admixture of rust shavings, crushed amber, and powdered dragon tooth has settled. The reaction yields 4 ounces of liquid, which are stored in a stoppered flask. With an action, you coat a weapon or up to ten arrows with one ounce of the solution. Any target damaged by these weapons takes 1d6 fire damage. Additionally, the entire flask can be thrown, causing an explosion which deals 3d6 fire damage and 3d6 force damage to all enemies within 10 feet.</div>
...
export const luminance = <div className="default">An item you choose begins to glow with a gentle blue or yellow aura. You may combine this enchantment with a divination spell (by casting both at the same time) to make the aura only appear when some condition is met.</div>

export const solstice = <div className="default">A beam of healing sunlight shines down on an area and remains for duration of the spell. Within the spell's effect radius of 10 feet, allies gain 1d6 healing, while enemies take 1d6 <span style={{color: "#FFA"}}>Holy</span> damage. This effect is applied when the spell is cast, and again at the start of your turn.</div>

export const bolster = <div className="default">Grant an ally 5 temporary hitpoints and increase their BC by 5 for as long as concentration is maintained.</div>

export const starlight = <div className="default">Illuminate an area (no larger than an acre) with a soft blue celestial light. The light is only visible to you and your allies. Living creatures illuminated by this light glow brightly, but not the undead or automatons.</div>

export const holy_aurora = <div className="default">A spectral halo of prismatic light circles the head of an ally you choose. For every turn concentration is maintained, they heal 1d6 hitpoints per turn and deal 1d6 bonus <span style={{color: "#FFA"}}>Holy</span> damage with their melee attacks. In addition, they cannot be <Tooltip tip={"Blinded"}>The target cannot see, has disadvantage on attack rolls, and automatically fails any ability checks and saving throws based on sight.</Tooltip> by magical effects.</div>

export const high_noon = <div className="default">Deal <span style={{color: "#FFA"}}>Holy</span> damage to a target by its remaining willpower.</div>

export const soul_equinox = <div className="default">A mote of light damages an enemy for 10 <span style={{color: "#FFA"}}>Holy</span> damage and then heals an ally by 10. If the enemy succeeds a DT 10 <Sub skill="Defense" /> saving throw, the damage and healing are reduced by half.</div>
...
export const barkskin = <div className="default">The caster's skin gradually gains a thick covering resembling the bark of a tree. Their BC increases by 2 each turn concentration is maintained, up to a maximum of 10.</div>

export const thorn_whip = <div className="default">The caster lashes out with the power of thorns, coiling around the target and dragging them 5 feet towards the caster. The target takes 2d6 piercing damage and is dragged up to 10 feet towards the caster. If the target makes a DT 10 <Sub attr="STR"/> saving throw, the target takes half damage and is not dragged.</div>

export const aromatherapy = <div className="default">Soothed by the scent of magical incense, the party heals 3d6 damage during the ritual.</div>

export const tree_speech = <div className="default">Placing their hands on a tree, the caster gains the ability to converse with a forest. Trees bear a timeless wisdom, and are able to communicate with other trees via their roots. Trees cannot see or speak (to humans) but they can distinguish animals, humans, and intruders within the limits of their root network.</div>
...
export const hawks_eyes = <div className="default">For one hour, gain advantage on perception checks. You see objects clearly, up to a distance of 10 miles.</div>

export const ravens_wings = <div className="default">Feathered wings sprout from your back, imbuing you with the ability to fly. The coloration and shape of the wings is unique to each caster, often a reflection of their underlying personality. Casting this spell for the first time is often treated as a coming-of-age ritual in druid circles.</div>

export const lacerate = <div className="default">You make a horizontal slashing motion with your hands, causing a large spectral paw to slice their air with its claws. Enemies lined up horizontally in front of you must make a <Sub attr="STR"/> saving throw or take 2d12 <span style={{color: "#CFF"}}>Slashing</span> damage. On a successful save, they take half damage.</div>

export const mole = <div className="default">For one hour, gain the ability to tunnel through dirt. Your tunneling speed is one foot per second. Creatures cannot follow you in your burrow unless you expend 1 willpower per 10 feet to make it wide enough to follow.</div>

export const owls_wisdom = <div className="default">The caster's <Sub attr="INT"/> increases by 1d8 for 8 hours.</div>
...
export const awaken_beastie = <div className="default">A beast is permanently awakened to sentience, gaining +3 to <Sub attr="INT"/> and +3 to <Sub attr="CHA"/> in addition to the ability to speak. It automatically joins you in combat, unless mortally afraid. After one week of sentience, the animal must make a DT 14 <Sub attr="CHA"/> saving throw or be overcome with existential angst, whereupon it will plead the caster to revoke sentience (which is done by casting the spell a second time).</div>

export const oneiromancy = <div className="default">During the ritual, the caster beseeches the fey for a vision concerning an important topic, and then falls into a magical slumber. While asleep, the caster receives a vision. The storyteller privately rolls a d20, which determines how directly the vision answers the question. On a 1, the vision (fantastical as it may be) bears absolutely no relation to the question at hand, and may even be malicious fey trickery.</div>
...
export const soul_sight = <div className="default">For one hour, gain the ability to perceive latent spirits and the lingering deceased.</div>

export const augury = <div className="default">TODO</div>
...
export const life_leach = <div className="default">A ray of black energy arcs from the hands of the caster to their target. The target takes 1d4 <span style={{color: "#92F"}}>Profane</span> damage on the first turn the spell is cast and 1d6 damage on subsequent turns. The healer is healed by 1 for every point of damage dealt.</div>
...
export const mend = <div className="default">The caster magically repairs a small wound, crack, or tear in a person or object. The target must be smaller than one cubic foot of volume.</div>

export const clay_armor = <div className="default">The caster's skin becomes hardened clay for one hour, improving BC by 5.</div>

export const quake = <div className="default">The caster concentrates on accumulating seismic forces within the earth. A patch of ground with a radius of 10 feet begins to tremble and undulate noticeably. When the spell is ended, all targets within 30 feet of the caster take 1d10 <span style={{color: "#D00"}}>Force</span> damage for every turn concentration was maintained.</div>

export const quicksand = <div className="default">Transform solid ground into sinking sand. The affected area becomes difficult terrain. Additionally, targets which start their turn on the quicksand must make a DT 14 <Sub skill="Mobility" /> saving throw or lose the ability to move.</div>

export const acid_blade = <div className="default">Imbue a blade you touch with the power of acid. For one hour, attacks with the weapon deal 1d4 <span style={{color: "#AF0"}}>Acid</span> damage and decrease enemy BC by 1.</div>

export const clay_golem = <div className="default">A clay golem is summoned for 8 hours. Though the weakest of the golems, it has resistance to <span style={{color: "#888"}}>Bludgeoning</span> and <span style={{color: "#FFF"}}>Piercing</span> damage due to its soft body.</div>

export const stone_armor = <div className="default">The caster's skin becomes brittle stone, improving BC by 7. The armor shatters after 10 <span style={{color: "#888"}}>Bludgeoning</span> damage is taken, ending the spell.</div>

export const earthen_wall = <div className="default">A great earthen wall up to 100 feet long appears in the indicated location, obstructing movement. The wall can absorb 50 damage before it breaks, and is immune to <span style={{color: "#F80"}}>Heat</span> damage. Targets over the area where the wall was constructed are pushed aside.</div>

export const stone_golem = <div className="default">Summon a stone golem. The golem is vulnerable to <span style={{color: "#888"}}>Bludgeoning</span> damage, but resistant to <span style={{color: "#FFF"}}>Piercing</span> damage.</div>

export const iron_armor = <div className="default">Your skin becomes covered by a magical metallic liquid. The liquid condenses and becomes firm wherever an arrow, missile, or blade would strike true. Block Chance is increased by 10.</div>

export const awaken_statue = <div className="default">A statue you touch comes to life for one hour. The statue may assist you in battle or inform you events that have transpired since it was built.</div>

export const earthquake = <div className="default">The ground around you rumbles and shakes, as your spell unleashes a mighty earthquake. Creatures within 300 yards take 3d12 <span style={{color: "#D00"}}>Force</span> damage and have disadvantage on the saving throw to avoid being knocked prone.</div>
...
export const flame_wall = <div className="default">A wall of flames, 20 feet in height, surges up from scorched and blackened ground. Creatures which pass through the wall take 3d12 <span style={{color: "#F80"}}>Heat</span> damage. Any creatures standing where the wall is cast take 2d12 <span style={{color: "#F80"}}>Heat</span> damage.</div>
...
export const shape_water = <div className="default">You may shape water into a form you choose, and freeze so that it retains its form. This spell can manipulate, freeze, or melt up to 100 pounds of water per cast.</div>
...
export const ice_statue = <div className="default">An enemy makes a DT 16 <Sub skill="Defense" /> aving throw or is instantaneously encased into a block of ice. On a successful save, the target accumulates 3 levels of <Tooltip tip={"Freezing"}>Accumulates. The target's Dexterity is reduced by 1 for each turn of accumulated freezing. Freezing decreases by 1 at the end of every turn.</Tooltip> instead. If this is sufficient to trigger the <Tooltip tip={"Frozen"}>The target is encased in ice and incapacitated. They become vulnerable to Force and Bludgeoning, but resistant to all other forms of damage.</Tooltip> status, then so be it.</div>

export const tsunami = <div className="default">A great wall of water appears, sweeping across the battlefield in a wide berth 100 feet wide. Targets take 4d10 <span style={{color: "#D00"}}>Force</span> damage and must make a DT 20 <Sub skill="Mobility" /> saving throw or be pushed up to 100 yards by the wall of water.</div>

export const thunderbolt = <div className="default">A bolt of lightning from the heavens strikes a single enemy, dealing 1d10 damage.</div>

export const electrocute = <div className="default">Attempt an unarmed attack on an opponent. On a success, deal 1d8 <span style={{color: "#FF4"}}>Lightning</span> damage in addition to your normal damage.</div>
...
export const lighting_storm = <div className="default">A dark thundrous cloud spreads over a 50-foot radius around a point up to 100 yards away. Each target within the area takes 1d20 <span style={{color: "#FF4"}}>Lightning</span> damage.</div>

export const storm_golem = <div className="default">Summon the mighty storm golem, the most powerful elemental entity which can be summoned and bidden.</div>

export const hurricane = <div className="default">By the power of this ceremony, a mighty hurricane is formed and travels along the path you have ordained. Roll a d20. The category of the hurricane is as follows: <ul><li><b>1-9</b>:1</li><li><b>11-14</b></li><li><b>15-17</b>: 3</li><li><b>18-19</b>: 4</li><li><b>20</b>: 5</li></ul></div>
...
export const minor_telepathy = <div className="default">You read the thoughts of a creature within 100 feet of you. You may also impart your own thoughts into their mind. Unwilling targets make a DT 15 <Sub attr="CHA"/> saving throw to resist. If successful, they reject your contact and have advantage on willpower saving throws against your psychic spells for the next 24 hours.</div>
...
export const psyblast = <div className="default">Deal 4d6 <span style={{color: "#D00"}}>Force</span> damage to an enemy. If it fails a DT 16 <Sub skill="Mobility" /> saving throw, it is also knocked back 10 feet.</div>
