...
statusRecoveries.register("bleeding", bleeding)

statusRecoveries.register("blinded", blinded)

statusRecoveries.register("burning", burning)

statusRecoveries.register("deafened", deafened)

statusRecoveries.register("incapacitated", incapacitated)

statusRecoveries.register("intoxicated", intoxicated)

statusRecoveries.register("terrified", terrified)

statusRecoveries.register("dazed", dazed)

statusRecoveries.register("prone", prone)

statusRecoveries.register("lethargic", lethargic)

statusRecoveries.register("madness", madness)

statusRecoveries.register("restrained", restrained)

statusRecoveries.register("freezing", freezing)

statusRecoveries.register("frozen", frozen)

statusRecoveries.register("petrified", petrified)

statusRecoveries.register("poisoned", poisoned)

statusRecoveries.register("levitated", levitated)

statusRecoveries.register("invisibility", invisibility)

statusRecoveries.register("ephemeral_invisibility", ephemeral_invisibility)